...
<body>
    ...
    <nav class="nav-bar">
        ...
        <div class="right-nav">
            <p>Don't have an account? <a href="../sign-up/index.php">Sign Up</a></p>
        </div>
    ...
    <section class="hero">
        ...
        <img src="../../images/icons/sent-email.png" alt="Forgot Password Icon" class="forgot-img">
        ...
        <a href="../login/login.php" class="back-to-login">
