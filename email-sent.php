...
<body>
    ...
    <section class="hero">
        ...
        <p>We Emailed a 6 digit code to madufaithful1@gmail.com. <br> Enter the code below to recover your account.</p>

        <div class="inputs-div">
            <input type="text" class="otp" inputmode="numeric" pattern="[0-9]*" maxlength="1" required>
            <input type="text" class="otp" inputmode="numeric" pattern="[0-9]*" maxlength="1" required>
            <input type="text" class="otp" inputmode="numeric" pattern="[0-9]*" maxlength="1" required>
            <input type="text" class="otp" inputmode="numeric" pattern="[0-9]*" maxlength="1" required>
            <input type="text" class="otp" inputmode="numeric" pattern="[0-9]*" maxlength="1" required>
        ...
        <input type="submit" name="submit" value="Send Code" class="submit">
